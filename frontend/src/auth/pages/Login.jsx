...
const HERO_SLIDES = [
  {
    ...
    subtitle: "Join thousands of professionals managing clients, projects, and invoices with FreelancerFlow.",
    badge: "All-in-One CRM",
    stat: "10k+ Freelancers"
  },
  {
    title: "Automate invoices & get paid 3x faster.",
    subtitle: "Create professional estimates, send automated reminders, and accept instant payments online.",
    badge: "Smart Billing",
    stat: "$12M+ Processed"
  },
  {
    title: "Track projects & impress your clients.",
    subtitle: "Seamless client portals, time tracking, and milestones to keep every project on schedule.",
          ...
          <div className="my-auto max-w-sm w-full mx-auto">
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 text-center">
              <p className="text-sm text-slate-600">
                ...
                <a
                  href="#signup"
                  onClick={(e) => { e.preventDefault(); alert('Redirecting to Registration flow...'); }}
