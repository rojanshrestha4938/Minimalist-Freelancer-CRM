...
const HERO_SLIDES = [
  {
    ...
    subtitle: "Join thousands of independent professionals managing projects, clients, and invoices with unparalleled clarity and speed.",
    badge: "All-in-One CRM",
    stat: "10k+ Freelancers"
  },
  {
    title: "Stay organized & boost client trust.",
    subtitle: "Centralize communications, project timelines, and deliverable handoffs in one branded client portal.",
    badge: "Client Experience",
    stat: "99.4% Satisfaction"
  },
  {
    title: "Automate billing & scale your revenue.",
    subtitle: "Create professional contracts, send recurring invoices, and track your cashflow automatically.",
    badge: "Smart Billing",
    stat: "$12M+ Processed"
  }
];
...
export default function Register({ onNavigateToLogin }) {
  ...
  return (
    <div className="min-h-screen w-full flex bg-slate-50 font-sans text-slate-900">
      {/* Container holding Hero Side and Form Side */}
      <div className="w-full flex min-h-screen">
        
        {/* LEFT COLUMN: Hero & Branding Banner (Visible on lg screens and up) */}
        <div className="hidden lg:flex lg:w-7/12 xl:w-3/5 relative bg-indigo-950 flex-col justify-between p-12 xl:p-16 overflow-hidden select-none">
          ...
          {/* Center Dynamic Content / Hero Slider */}
          ...
          {/* Bottom Footer & Slide Pagination Indicators */}
              ...
              <div className="flex items-center justify-between py-1">
                <label className="flex items-center gap-2.5 cursor-pointer group select-none">
                  ...
                  <span className="text-sm font-normal text-slate-600 group-hover:text-slate-900 transition-colors">
                    ...
                    <a
                      href="#terms"
                      onClick={(e) => { e.preventDefault(); alert('Terms & Conditions modal'); }}
